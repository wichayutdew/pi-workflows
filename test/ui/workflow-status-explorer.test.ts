...
import { createStepExecutionActions } from '../../src/infrastructure/harness/step-execution-actions.ts';
import type { WorkflowStepResult } from '../../src/domain/index.ts';
import {
  redactStepLogText,
  redactStepLogValue,
  stepLogLinesFromMessage,
  textOnlyUserMessage,
} from '../../src/ui/step-log.ts';
import {
  readStepTranscript,
  WorkflowStatusView,
