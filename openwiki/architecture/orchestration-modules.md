...
| `src/infrastructure/harness/gate-submission-action.ts`         | Converts a gated `ready` result into persisted pending-review state and launches the selected review provider.                                                                                  |
